!> \file mo_opti_variables.f90

!> \author Xiaoqiang Yang
!> \date Apr 2022
module mo_opti_variables
  ...
  type period
   ...
   ! OPTIMIZATION
   ! -------------------------------------------------------------------
    real(dp), public              :: funcbest    ! best objective function achivied during optimization
    logical,  dimension(:),allocatable, public :: maskpara ! true  = parameter will be optimized     = parameter(i,4) = 1
