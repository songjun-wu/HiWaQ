...
CONTAINS
  ...
  subroutine paste_conc(mat1, mat2, fill_value)
    ...
    use mo_wqm_constants,  only: maxnWQinputCols  !maximum number of observed data type
    implicit none
    ...
    s3 = size(mat2,2)  !columns, should equals "maxnWQinputCols"
    if (s3 > maxnWQinputCols) then
